  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "22px" }}>
            <p>
              ...
              products at unbeatable prices. Enjoy a seamless shopping
              experience with secure payments and fast delivery.
            </p>

            <p>
              From fashion and electronics to jewelry and home essentials,
              discover premium products curated just for you.
            </p>

            <p>
              Browse thousands of quality products across multiple categories.
              Enjoy secure checkout, personalized recommendations, and
        ...
        >
          <Button as={Link} to="/Productpage" style={{ margin: "10px" }}>
            Start Shopping →
          </Button>
        </div>
      </div>
