        ...
        <Accordion defaultActiveKey="">
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body className="text-[17px] font-serif">
              As a Java Developer, I am responsible for developing and
              maintaining enterprise-level backend applications using Core Java
              and Spring Boot. I work on implementing business requirements,
              developing backend services, and building REST APIs to support
            ...
            <Accordion.Body className="text-[17px] font-serif">
              ...
              domain, supporting lending workflows and ensuring smooth
